...
void StoryManager::Prologue()
{
    ...
    cout << "즐거움의 왕국 다이시아. 이곳은 그 옛날 누군가 남긴 한마디처럼 모두가 주사위 놀이를 즐깁니다. 다들 주사위 눈에 울고, 웃고, 화내고…활기로 가득한 곳으로 알려져 있죠." << endl;

    cout << "당신의 파티는 다이시아 왕국의 거리를 걸어가고 있습니다. 소문과 달리 거리의 분위기는 어딘지 침울해보입니다. 노점 상인에게 이유를 물어봅니다." << endl;

    cout << "\"왕국에 대대로 전해져 오는 보물, 신비한 힘이 깃든 황금 주사위를 던전의 주인이 훔쳐 마물을 육성하는데 쓰고 있다네.\"" << endl;
    cout << "상인은 주변을 한 번 살피더니, 어깨를 으쓱하며 재차 말을 이어갑니다.\n" << endl;
    cout << "\"황금 주사위의 힘 때문에 마물들은 주사위를 통해서만 쓰러뜨릴 수 있게 됐어.\"" << endl;
    cout << "상인은 잠시 말을 멈추고 먼 산을 바라보며 깊은 한숨을 내쉽니다.\n" << endl;
