...
void StoryManager::Prologue()
{
    ...
    cout << "즐거움의 왕국 다이시아. 이곳은 그 옛날 누군가 남긴 한마디처럼" << endl;
    cout << "모두가 주사위 놀이를 즐깁니다. 다들 주사위 눈에 울고, 웃고, 화내고…" << endl;
    cout << "활기로 가득한 곳으로 알려져 있죠.\n" << endl;

    cout << "당신의 파티는 다이시아 왕국의 거리를 걸어가고 있습니다." << endl;
    cout << "소문과 달리 거리의 분위기는 어딘지 침울해보입니다." << endl;
    cout << "노점 상인에게 이유를 물어봅니다.\n" << endl;

    cout << "\"왕국에 대대로 전해져 오는 보물, 신비한 힘이 깃든 황금 주사위를 던전의 주인이 훔쳐 마물을 육성하는데 쓰고 있다네.\"" << endl;

    cout << "\n상인은 주변을 한 번 살피더니, 어깨를 으쓱하며 재차 말을 이어갑니다.\n" << endl;

    cout << "\"황금 주사위의 힘 때문에 마물들은 주사위를 통해서만 쓰러뜨릴 수 있게 됐어.\"" << endl;

    cout << "\n상인은 잠시 말을 멈추고 먼 산을 바라보며 깊은 한숨을 내쉽니다.\n" << endl;

    cout << "\"다른 모험가들이 몇 번 목숨을 걸고 던전에 들어갔지만, 모두 불운한 결말을 맞았지.\"" << endl;
    cout << "\"임금님께선 황금 주사위만 구해온다면 그에 걸맞은 보상을 약속하셨다네.\"" << endl;

    cout << "상인이 가판대 너머로 당신의 파티를 훑어보며 덧붙입니다.\n" << endl;

    cout << "\"혹시 모르지, 운만 좋다면 자네들이 그 주인공이 될지도.\"\n" << endl;

    cout << "당신은 흥미를 느끼며, 자신의 운을 시험해보기로 결심합니다." << endl;
...
void StoryManager::Stage3Story()
{
    ...
    cout << "그것은 오크가 피운 모닥불이었고, 오크 자신의 휴식을 방해한 자들을" << endl;
    cout << "용서할 기색이 없습니다." << endl;
...
void StoryManager::EndingStory()
{
    ...
    cout << "왕궁의 예법에 익숙지 않은 당신의 파티는 왕 앞에 나아가 어색하게 무릎을 꿇습니다.\n" << endl;

    cout << "\"잘 왔네. 우리나라에 황금 주사위를 돌려준 자네들에게 감사를 표하지.\"\n" << endl;
